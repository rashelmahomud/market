...
const NewsDetails = ({ post }) => {
  ...
  return (
    <div>
      <Head>
        <title> Market /News Details</title>
      </Head>
      <Header></Header>
        ...
        <div className="grid lg:grid-cols-3 gap-4">
            ...
            <div className="shadow relative overflow-hidden lg:px-20">
              ...
              <div className="bg-gray-100 flex">
                <div className="lg:p-10 p-3 ">
                  <p className="flex items-center text-5xl bg-gray-400 w-16 h-16 p-2 rounded-full">
                    <AiOutlineUser />
                  </p>
                ...
                <div className="mt-32 p-3 lg:p-10">
                  <span className="flex items-center gap-3 text-gray-600">
                    {" "}
                    <BsFillChatLeftFill /> Electronics
                  </span>
                  <h2 className="font-bold text-2xl text-gray-600 my-3">
                  ...
                  <button className="bg-green-700 p-3 mt-3 text-white font-bold ">
                    continue Reading
                  </button>
                </div>
              </div>
          ...
          <div>
            <div className="p-10 mt-10 border w-96 flex">
              ...
              />
              <button className="bg-yellow-300 p-3 text-white font-bold">
                <BsSearch />
              </button>
            </div>
            <div className="border p-5 my-3 w-96">
              <h3 className="font-semibold text-xl mb-3 border-l-4 px-2">
                Recent Posts
              </h3>
              <Link href="#">
                Seating Collection Inspiration Is Not Enough For People
              ...
              <hr />
              <br />
              <Link href="#">Creative Water Features And Exterior Design</Link>
              <hr />
              <br />
              <Link href="#" className="">
                Seating Collection Inspiration Is Not Enough For People
            ...
            <div className="border p-5 my-5 w-96 ">
              ...
              <Link href="#">Maria on Xpeed computer</Link>
              <hr />
              <br />
              <Link href="#">Maria on Xpeed Laptop</Link>
              <hr />
              <br />
              <Link href="#"> Maria on Fuji Film Camera</Link>
              <hr />
              <br />
              <Link href="#">Maria on Xpeed Headset</Link>
              <hr />
              <br />
              <Link href="#" className="">
                Ryan on Drone WI FI FPV
              </Link>
              <hr />
            </div>
            <div className="border p-5 my-5 w-96">
              <h3 className="font-semibold text-xl mb-3 border-4 border-l-indigo-400 px-2">
                Archives
              </h3>
              <Link href="#">May 2018</Link>
              <hr />
              <br />
              <Link href="#">April 2018</Link>
              <hr />
              <br />
              <Link href="#">March 2018</Link>
              <hr />
            </div>
            <div className="border p-5 my-5 w-96">
              <h3 className="font-semibold text-xl mb-3 border-4 border-l-indigo-400 px-2">
...
export const getServerSideProps = async (context) => {
  ...
  const { id } = params;
  const res = await fetch(`https://market-shop-server.onrender.com/market?id=${id}`);
...
//     const res = await fetch(`https://market-shop-server.onrender.com/market/${params.id}`)
