        ...
        <div>
            <div className="grid lg:grid-cols-2 grid-cols-1  lg:px-20 px-5 p-16 bg-lime-500 ">
                <div className="text-center">
                    <h1 className="text-3xl font-bold text-white text-center">Newsletter & Get Updates</h1>
                    <p className="text-white">Sign up for our newsletter to get up-to-date from us</p>
                </div>

                <div>
                    <input type="text" className="border rounded lg:w-96 p-3" placeholder="Enter your Mail Here.." />
                    <button className="bg-red-400 p-3 text-white font-bold">SUBMITE</button>
                </div>
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-10 lg:px-20 px-5 p-12 relative">
                ...
                <div>
                    ...
                    <h3 className="mt-5 text-gray-400 text-2xl">Got Question? Call us 24/7</h3>
                    ...
                    <button className="bg-red-400 p-3 mt-3 text-white font-bold">View On Map</button>
                </div>
                <div>
                    <h1 className="text-2xl text-gray-600 font-bold">We Using Safe Payments</h1>
                ...
                <ul>
                    ...
                    <button className="flex items-center bg-red-400 p-3 mt-3 text-white font-bold absolute ml-36 -rotate-90">Back Top <BsArrow90DegRight className="text-2xl m-2"/> </button>
